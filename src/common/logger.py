...
logger.setLevel(os.environ.get("DEBUG_LEVEL", "WARNING"))
...
c_handler.setLevel(os.environ.get("DEBUG_LEVEL", "WARNING"))
f_handler.setLevel(os.environ.get("DEBUG_LEVEL", "WARNING"))
